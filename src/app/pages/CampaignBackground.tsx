      ...
      <main className="article-container">
        ...
        <LinkSection 
          ...
          items={[
            ...
            { label: "연합뉴스 - 서안 점령지 농산물, 이스라엘산 둔갑해 EU 유입", href: "https://www.yna.co.kr/view/AKR20260611176300081" }
          ]} 
        />
        <LinkSection 
          title="✍️ 서명 참여하기" 
